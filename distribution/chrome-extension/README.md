...
`navigate`, `snapshot`, `click`, `type`, `scroll`, `back`, `forward`,
`screenshot` (captures your real tab and shows it to vision models), and tab
management across your real browser: `list_tabs`, `open_tab`, `switch_tab`.
`console` currently runs on the Playwright backend.
